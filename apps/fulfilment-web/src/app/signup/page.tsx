...
function signupContext(redirect: string | null): { title: string; subtitle: string; step2: string } {
  ...
  return {
    title: "Create your Faira Fulfilment account",
    subtitle: "Ship through Faira's hubs — onboarding, shipments and tracking in one place.",
    step2: "Get started",
  };
}
